...
const getCardPinToken = async (req, res, next) => {
    try {
        const {uid} = req.body
        ...
        const galileoResponse = await axiosInstance.post('getCardPinChangeKey', encodedParams);
...
module.exports = getCardPinToken;